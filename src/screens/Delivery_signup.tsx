...
const DeliverySignupScreen = ({ navigation }) => {
  ...
  const handleCreateAccount = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        Alert.alert('Success', 'Delivery account created successfully!', [
          { text: 'OK', onPress: () => navigation.navigate('deliveryDash') }
        ]);
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        style={styles.input}
        placeholder="Enter delivery man's name"
        value={name}
